  ...
  return (
    <main id='certificate' className='w-full h-max flex flex-col justify-center pt-20 '>
        ...
        <div className='w-full h-max px-10 py-7 flex flex-wrap gap-7 justify-center'>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img1} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img2} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img3} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img4} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img5} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img6} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img7} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img8} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img9} className='h-52'></Image>
            </div>
            <div className='w-max hover:scale-[1.1] hover:duration-100 hover:ease-in-out lg:w-1/4 '>
                <Image src={img10} className='h-52'></Image>
            </div>
        </div>
    </main>
  )
